...
const slider = document.createElement("web-provenance-slider") as NgElement &
  WithProperties<SliderComponent>;
...
document
  .querySelector("label[for='wp-range-slider']")
...
const inputtext = document.createElement(
  "web-provenance-inputtext"
) as NgElement & WithProperties<InputtextComponent>;

document
  .querySelector("label[for='wp-inputtext']")
...
) as NgElement & WithProperties<MultiselectComponent>;
...
document
  .querySelector("label[for='wp-multiselect']")
...
) as NgElement & WithProperties<DropdownComponent>;
...
document
  .querySelector("label[for='wp-dropdown']")
  ?.insertAdjacentElement("afterend", dropdown);

// Checkbox
const checkbox = document.createElement(
  "web-provenance-checkbox"
) as NgElement & WithProperties<CheckboxComponent>;
...
document
  .querySelector("label[for='wp-radiobutton']")
